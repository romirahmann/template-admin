...
export class HeatmapComponent implements OnInit {
  ...
  ngOnInit(): void {
    ...
    */
    ...
    this._basicHeatmapChart('["--vz-success", "--vz-card-custom"]');
    this._multipleSeriesChart('["--vz-primary", "--vz-secondary", "--vz-success", "--vz-info", "--vz-warning", "--vz-danger", "--vz-dark", "--vz-primary", "--vz-card-custom"]');
